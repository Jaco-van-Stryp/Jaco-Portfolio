  ...
  protected readonly nodes: TrajectoryNode[] = [
    {
      ...
      type: 'education',
      icon: '📚',
      highlights: ['Completed high school education', 'Started programming journey'],
      tech: [],
      x: 60,
      y: 280,
    },
    ...
    },
    {
      ...
      icon: '⚡',
      highlights: [
        'Founded and operated a software development consultancy',
        'Built end-to-end web applications for multiple clients',
        'Managed full project lifecycle — requirements through deployment',
    ...
    },
    {
      ...
      icon: '🌱',
      highlights: [
        'Developed banking software deployed across 10 African countries',
        'Gained deep experience in application support',
        'Focused on user-driven solution design',
      ],
      tech: ['C#', 'ASP.NET', 'Angular', 'SQL Server', 'Azure'],
      x: 380,
      y: 120,
    },
    {
      ...
      tech: ['C#', 'ASP.NET', 'Angular', 'React', 'SQL Server'],
      x: 490,
      y: 100,
    },
    {
      ...
      icon: '🏦',
      highlights: [
        'Built Vitals — automated recovery maintaining near-100% uptime',
        '30+ banking institutions across 10 African countries',
      ...
      tech: ['C#', 'ASP.NET', 'Angular', 'React', 'SQL Server', 'Azure', 'Team Leadership'],
      x: 620,
      y: 120,
    },
    {
