...
export class MissionStateService {
  ...
  readonly badges = computed<MissionBadge[]>(() => [
    ...
    },
    {
      ...
      earned: this._visitedSections().has('about'),
      icon: '🧑‍🚀',
    },
    {
      id: 'navigator',
      ...
      earned: this._visitedSections().has('experience'),
      icon: '🗺️',
    },
    {
      id: 'payload',
      ...
      earned: this._visitedSections().has('projects'),
      icon: '📦',
    },
    {
      id: 'diagnostics',
      ...
      earned: this._visitedSections().has('skills'),
      icon: '⚙️',
    },
    {
      id: 'reentry',
      ...
      earned: this._visitedSections().has('contact'),
      icon: '📡',
    },
    {
      id: 'complete',
